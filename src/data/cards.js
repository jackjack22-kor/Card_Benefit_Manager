...
export const CARDS = [
  ...
  },
  {
    ...
    benefits: [
      ...
      { id: 'the1-amex-hotel-elite', name: 'AMEX 호텔 우대 서비스', type: 'info_check', priority: 'normal', categories: ['hotel'], summary: '국내 특급 호텔 객실 5~40% 할인 또는 무료 업그레이드, F&B 5~10% 할인, 해외 호텔 할인 및 고택 호텔 우대', targets: 'PDF 기준 34개 국내 특급 호텔, 반얀트리/그란 멜리아 등 해외 호텔, JW 메리어트 하노이, 구름에, 조선 왕가 호텔, 락고재 서울 북촌/안동 하회', exclusions: '호텔별 예약 경로, 제외 기간, 객실 상황에 따라 조건 상이. 이용 전 Amex/삼성카드 안내 확인 필요.', conditions: 'AMEX PLATINUM ELITE 등급서비스. 예약 시 AMEX 카드 회원임을 알리고 해당 카드 제시 또는 결제 필요.', homeLabel: 'AMEX호텔' },
